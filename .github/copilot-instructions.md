...
_Version: aligned with authentication.md v1.3.0 · database_schema.md v1.5.1 · project_structure.md v1.1.0_
_Scope: Free/Basic plan (teacher-only, no student portal, no LMS)_
